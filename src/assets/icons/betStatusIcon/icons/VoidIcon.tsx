...
const VoidIcon = ({ testId = 'testId' }: Testable) => (
    <SvgElement testId={testId}>
        ...
        <circle cx="8" cy="8" r="7.5" fill="none" stroke="#FEBE3F" stroke-width="1" />
        <text data-testid={`bet-status-icon-${testId}`} x="8" y="12" text-anchor="middle" font-size="11" font-family="Noto Sans" fill="#FEBE3F">V</text>
    </SvgElement>
);
