...
const koreanGroups: Record<string, string[]> = {
    ㄱ: [SPORT_TYPE.golf, SPORT_TYPE.betlinkgolf, SPORT_TYPE.combatsports],
    ...
    ㅇ: [SPORT_TYPE.icehockey, SPORT_TYPE.baseball, SPORT_TYPE.olympicgames, SPORT_TYPE.archery, SPORT_TYPE.athletics],
    ㅊ: [SPORT_TYPE.football],
    ㅋ: [SPORT_TYPE.cricket, SPORT_TYPE.csgo],
    ㅌ: [SPORT_TYPE.tabletennis, SPORT_TYPE.tennis, SPORT_TYPE.taekwondo],
