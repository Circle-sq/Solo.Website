...
it('should render Highlight sports list', () => {
    const mockLinksData = [
        {
            imageUrl:
                'https://s3.eu-central-1.amazonaws.com/skycityhub-qa-cms/icons/competitions/6b730d2c-0bb1-479a-ab44-c4e5fb2f73f2.svg',
            label: 'NBA',
        ...
        {
            imageUrl:
                'https://s3.eu-central-1.amazonaws.com/skycityhub-qa-cms/icons/competitions/b425752b-3ca8-4860-836a-97b6935b76db.svg',
