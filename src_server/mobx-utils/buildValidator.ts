...
const failure = (es: Array<ValidationError>): Array<MessageType> =>
    es.map((e: ValidationError): MessageType => {
...
export const buildValidator = <A>(label: string, decoder: t.Type<A>, dumpDataWhenError = false): Validator<A> => {
